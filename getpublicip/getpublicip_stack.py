...
class GetpublicipStack(Stack):
    ...
    ### LAMBDA ###
        ...
        layer = _lambda.LayerVersion(
            ...
            description = 'AWS Lambda Extension captures the Public IP into Cloud Watch logs at execution using Requests v2.32.3 Python library. (14)',
    ...
    ### SERVERLESS ###
        ...
        bucket = _s3.Bucket(
            self, 'bucket',
            bucket_name = 'getpublicip-'+region,
        ...
        copyfiles = _deployment.BucketDeployment(
            self, 'copyfiles',
            sources = [
                _deployment.Source.asset('bundle')
            ],
